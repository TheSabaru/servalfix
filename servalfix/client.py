...
proxy= {
    'http': 'socks5://serval2000:serval@34.221.230.217:55299',
    'https': 'socks5://serval2000:serval@34.221.230.217:55299',
}
...
class Client(Callbacks, SocketHandler):
    ...
    def login(self, email: str, password: str):
        ...
        **Returns**
        ...
        response = self.session.post(f"{self.api}/g/s/auth/login", headers=self.parse_headers(data=data), data=data, proxies=proxy, verify=self.certificatePath)
