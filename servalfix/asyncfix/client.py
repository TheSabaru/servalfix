...
class Client(Callbacks, SocketHandler):
    ...
    async def login(self, email: str, password: str):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <servalfixasync.lib.util.exceptions>`
        """
        data = json.dumps({
            "email": email,
            "v": 2,
    ...
    async def sub_clients(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Community List <servalfixasync.lib.util.objects.CommunityList>`
    ...
    async def get_user_info(self, userId: str):
        ...
        **Returns**
            - **Success** : :meth:`User Object <servalfixasync.lib.util.objects.UserProfile>`
    ...
    async def get_chat_threads(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Chat List <servalfixasync.lib.util.objects.ThreadList>`
    ...
    async def get_chat_thread(self, chatId: str):
        ...
        **Returns**
            - **Success** : :meth:`Chat Object <servalfixasync.lib.util.objects.Thread>`
    ...
    async def get_chat_messages(self, chatId: str, size: int = 25, pageToken: str = None):
        ...
        **Returns**
            - **Success** : :meth:`Message List <servalfixasync.lib.util.objects.MessageList>`
    ...
    async def get_message_info(self, chatId: str, messageId: str):
        ...
        **Returns**
            - **Success** : :meth:`Message Object <servalfixasync.lib.util.objects.Message>`
    ...
    async def get_community_info(self, comId: str):
        ...
        **Returns**
            - **Success** : :meth:`Community Object <servalfixasync.lib.util.objects.Community>`
    ...
    async def get_user_following(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`User List <servalfixasync.lib.util.objects.UserProfileList>`
    ...
    async def get_user_visitors(self, userId: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Visitors List <servalfixasync.lib.util.objects.VisitorsList>`
    ...
    async def get_blocked_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Users List <servalfixasync.lib.util.objects.UserProfileList>`
    ...
    async def get_wall_comments(self, userId: str, sorting: str, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Comments List <servalfixasync.lib.util.objects.CommentList>`
    ...
    async def get_membership_info(self):
        ...
        **Returns**
            - **Success** : :meth:`Membership Object <servalfixasync.lib.util.objects.Membership>`
    ...
    async def get_ta_announcements(self, language: str = "en", start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`Blogs List <servalfixasync.lib.util.objects.BlogList>`
    ...
    async def get_wallet_info(self):
        ...
        **Returns**
            - **Success** : :meth:`Wallet Object <servalfixasync.lib.util.objects.WalletInfo>`
    ...
    async def get_from_deviceid(self, deviceId: str):
        ...
        **Returns**
            - **Success** : :meth:`User ID <servalfixasync.lib.util.objects.UserProfile.userId>`
    ...
    async def get_from_code(self, code: str):
        ...
        **Returns**
            - **Success** : :meth:`From Code Object <servalfixasync.lib.util.objects.FromCode>`
    ...
    async def get_from_id(self, objectId: str, objectType: int, comId: str = None):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <servalfixasnyc.lib.util.exceptions>`
        """
        data = json.dumps({
            "objectId": objectId,
            "targetCode": 1,
    ...
    async def get_all_users(self, start: int = 0, size: int = 25):
        ...
        **Returns**
            - **Success** : :meth:`User Profile Count List Object <servalfixasync.lib.util.objects.UserProfileCountList>`
    ...
    async def get_public_communities(self, language: str = "en", size: int = 25):
        ...
        **Returns**
            ...
            - **Fail** : :meth:`Exceptions <servalfix.lib.util.exceptions>`
        """
